...
//          postRequest();
    ...
    private static void postRequest() throws IOException {
        ...
        Response response = client.newCall(new Request.Builder()
                ...
                .build()).execute();
        System.out.println(new java.lang.String(response.body().bytes()));
    }
    ...
    private static void getWithQuery() throws Exception {
        ...
        java.lang.String string = new java.lang.String(response.body().bytes());
        User user = null;
